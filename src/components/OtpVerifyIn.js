...
//         await Axios.post('http://localhost:4000/user/verifyotp',userdata)
//         .then((resp)=>{
//             console.log(resp.data)
//             if(resp.data.message==='Verified Exitinguser'&&resp.success){
//                     alert('exitinguser')
//                     // navigate('/home')
//             }
//             else{
...
//                           {otp.map((digit, index) => (
//                             <label htmlFor="mobileNumber"  key={index}>
//                             <input id={`otp-input-${index}`}
//                               className='otp-input'
//                               type="text"
//                               value={digit}
//                               maxLength="1"
...
//                           ))}
//                         </div>
//                         <button className='sigin-otp-verify' onClick={verifyOtpHandler}>Verify</button>
